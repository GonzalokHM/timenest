...
import { Clock, Coins, Star, TrendingUp, Users, LogOut, User, Store, Activity } from "lucide-react"
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span className="font-medium">{profile?.time_tokens || 0} TimeTokens</span>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{profile?.time_tokens || 0}</div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Tiempo Semanal</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{profile?.reputation?.toFixed(1) || "5.0"}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{Math.floor((profile?.total_time_minutes || 0) / 60)}h</div>
        ...
        <Tabs defaultValue="timer" className="space-y-6">
          ...
          <TabsContent value="marketplace">
            <Marketplace userId={user?.id || ""} userTokens={profile?.time_tokens || 0} />
          </TabsContent>
          ...
          <TabsContent value="community">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Conecta con otros usuarios y descubre oportunidades de intercambio</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <Users className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                  <p className="text-muted-foreground">Funcionalidad de comunidad próximamente...</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
