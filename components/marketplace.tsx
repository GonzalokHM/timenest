...
import { Plus, Clock, User, Star, MessageCircle, HandHeart, Search, Filter } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Intercambia tiempo y habilidades con otros usuarios</p>
        </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>Ofrece tu tiempo o solicita ayuda de otros usuarios</DialogDescription>
            </DialogHeader>
            <form onSubmit={handleCreatePost} className="space-y-4">
              <div>
                <Label>Tipo de publicación</Label>
                <Select value={formType} onValueChange={(value: "offer" | "request") => setFormType(value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="offer">Ofrezco tiempo para...</SelectItem>
                    <SelectItem value="request">Necesito ayuda con...</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    value={formDuration}
                    onChange={(e) => setFormDuration(Number.parseInt(e.target.value))}
                    min="15"
                    max="180"
                    step="15"
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    value={formTokens}
                    onChange={(e) => setFormTokens(Number.parseInt(e.target.value))}
                    min="1"
                    max="10"
                  />
                </div>
...
function PostCard({ post, userTokens, onContact, isOwner }: PostCardProps) {
  ...
  const typeColor = post.type === "offer" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center text-sm text-muted-foreground">
            ...
            <div className="flex items-center ml-2">
              ...
              <span className="text-xs">{post.profiles.reputation.toFixed(1)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-auto">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-1">
              <span className="text-lg font-bold text-primary">{post.tokens_required}</span>
