...
export function Timer({ userId, currentTokens, onTokensUpdate }: TimerProps) {
  ...
  const handleTimerComplete = async () => {
    ...
    // Increment total time via stored procedure
    const { error: rpcError } = await supabase.rpc('increment_total_time', {
      user_id: userId,
      minutes: duration
    })
    ...
    if (rpcError) {
      toast({
        title: 'Error',
        description: 'No se pudo actualizar el tiempo total',
        variant: 'destructive'
      })
      return
    }
    ...
    toast({
      ...
      description: `Has ganado 1 TimeToken por completar ${duration} minutos de ${
      ...
      <div className='lg:col-span-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Registra tiempo productivo y gana TimeTokens
            </CardDescription>
          </CardHeader>
              ...
              <div className='relative'>
                ...
                {selectedActivityData && (
                  <div className='flex items-center justify-center space-x-2 mt-2'>
                    <div
                      className={`w-3 h-3 rounded-full ${selectedActivityData.color}`}
                    />
                      ...
                      <div className='flex items-center space-x-3'>
                        ...
                        <div>
                          <p className='font-medium text-sm'>
                            {activityData?.name || activity.activity_type}
                          </p>
